...
class DerivedItemTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.originalItem = OriginalItem('MYID12435', domain.STATUS_OK, ('800', '600'), domain.IMAGE_FORMAT_JPEG)
    ...
    def testShouldNotBeAbleToCreateItemWithNullStatus(self):
        try:
            DerivedItem(None, (800, 600), domain.IMAGE_FORMAT_JPEG, self.originalItem)
        except Exception:
            pass
        else:
            self.fail()
    ...
    def testShouldNotBeAbleToCreateItemWithNullWidth(self):
        try:
            DerivedItem(domain.STATUS_OK, (None, 600), domain.IMAGE_FORMAT_JPEG, self.originalItem)
        except Exception:
            pass
        else:
            self.fail()
    ...
    def testShouldNotBeAbleToCreateItemWithNullHeight(self):
        try:
            DerivedItem(domain.STATUS_OK, (800, None), domain.IMAGE_FORMAT_JPEG, self.originalItem)
        except Exception:
            pass
        else:
            self.fail()
    ...
    def testShouldNotBeAbleToCreateItemWithNullFormat(self):
        try:
            DerivedItem(domain.STATUS_OK, (800, 600), None, self.originalItem)
        except Exception:
            pass
        else:
            self.fail()
