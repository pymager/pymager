...
class OriginalItemTestCase(unittest.TestCase):
    ...
    def testShouldNotBeAbleToCreateItemWithNullId(self):
        try:
            Domain.OriginalItem(None, Domain.STATUS_OK, (800, 600), 'JPEG')
        except Exception:
            pass
        else:
            self.fail()
    ...
    def testShouldNotBeAbleToCreateItemWithNullStatus(self):
        try:
            Domain.OriginalItem('MYID12435', None, (800, 600), 'JPEG')
        except Exception:
            pass
        else:
            self.fail()
    ...
    def testShouldNotBeAbleToCreateItemWithNullWidth(self):
        try:
            Domain.OriginalItem('MYID12435', Domain.STATUS_OK, (None, 600), 'JPEG')
        except Exception:
            pass
        else:
            self.fail()
    ...
    def testShouldNotBeAbleToCreateItemWithNullHeight(self):
        try:
            Domain.OriginalItem('MYID12435', Domain.STATUS_OK, (800, None), 'JPEG')
        except Exception:
            pass
        else:
            self.fail()
...
class DerivedItemTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.originalItem = Domain.OriginalItem('MYID12435', Domain.STATUS_OK, ('800', '600'), 'JPEG')
    ...
    def __checkItem(self, item):
        ...
        assert item.originalItem.format == 'JPEG' 
    
    def testShouldIdBeAutogenerated(self):
        item = Domain.DerivedItem(Domain.STATUS_OK, ('100', '100'), 'JPEG', self.originalItem)
        assert item.id == 'MYID12435-100x100'
    ...
    def testShouldNotBeAbleToCreateItemWithNullStatus(self):
        try:
            Domain.DerivedItem(None, (800, 600), 'JPEG', self.originalItem)
        except Exception:
            pass
        else:
            self.fail()
    ...
    def testShouldNotBeAbleToCreateItemWithNullWidth(self):
        try:
            Domain.DerivedItem(Domain.STATUS_OK, (None, 600), 'JPEG', self.originalItem)
        except Exception:
            pass
        else:
            self.fail()
    ...
    def testShouldNotBeAbleToCreateItemWithNullHeight(self):
        try:
            Domain.DerivedItem(Domain.STATUS_OK, (800, None), 'JPEG', self.originalItem)
        except Exception:
            pass
        else:
            self.fail()
    ...
    def testShouldNotBeAbleToCreateItemWithNullOriginalItem(self):
        try:
            Domain.DerivedItem(Domain.STATUS_OK, (800, 600), 'JPEG', None)
        except Exception:
            pass
        else:
            self.fail()
